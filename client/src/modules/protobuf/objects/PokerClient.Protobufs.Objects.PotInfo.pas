...
unit PokerClient.Protobufs.Objects.PotInfo;

interface

uses
  Classes, SysUtils, {$IFNDEF FPC}System.Generics.Collections{$ELSE}Contnrs{$ENDIF}, pbOutput, PokerClient.Protobufs.Objects.Base, PokerClient.Protobufs.Reader,PokerClient.Protobufs.Objects.WinnerData;
