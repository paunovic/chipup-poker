...
type
  ...
  public
    ...
    procedure MergeFrom(const AFrom: TPB_PlayerLimitParams);
    procedure Clear;
...
procedure TPB_PlayerLimitParams.MergeFrom(const AFrom: TPB_PlayerLimitParams);
begin
  ...
  if AFrom.has_Unlimited then
    SetUnlimited(AFrom.Unlimited);
end;
