unit PokerClient.Protobufs.Objects.GiveClubOwnershipParams;

interface

uses
  Winapi.Windows, pbOutput, PokerClient.Protobufs.Objects.Base, PokerClient.Protobufs.Reader, System.SysUtils;
