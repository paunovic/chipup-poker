unit PokerClient.Protobufs.Objects.ChatEvent;

interface

uses
  Winapi.Windows, System.SysUtils, pbOutput, PokerClient.Protobufs.Objects.Base, PokerClient.Protobufs.Reader, PokerClient.Protobufs.Objects.ChatMessage;
