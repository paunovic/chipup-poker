...
type
  ...
  public
    ...
    procedure MergeFrom(const AFrom: TPB_StringSizes);
    procedure Clear;
...
procedure TPB_StringSizes.MergeFrom(const AFrom: TPB_StringSizes);
begin
  ...
  if AFrom.has_Invcode then
    SetInvcode(AFrom.Invcode);
  if AFrom.has_Username then
    SetUsername(AFrom.Username);
  if AFrom.has_Gamename then
    SetGamename(AFrom.Gamename);
  if AFrom.has_ContactMessage then
    SetContactMessage(AFrom.ContactMessage);
end;
