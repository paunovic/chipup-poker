...
type
  ...
  { TdxSkinChipUpRedButtonPainter }

  TdxSkinChipUpRedButtonPainter = class(TdxSkinLookAndFeelPainter)
  public
...
function TdxSkinChipUpRedButtonPainter.LookAndFeelName: string;
begin
  Result := 'ChipUpRedButton';
end;
