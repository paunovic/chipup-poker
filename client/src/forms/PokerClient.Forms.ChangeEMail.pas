unit PokerClient.Forms.ChangeEMail;
...
uses
  ...
  cxButtons, cxTextEdit, Vcl.ActnList,  dxsChipUpDark, dxsChipUpDarkTabs, dxsChipUpRedButton, Vcl.Menus;
...
uses
  PokerClient.DataModule, PokerClient.Server.Validators, PokerClient.Server.Socket, PokerClient.Protobufs.Enum.ServerCodes, PokerClient.Common.Misc, PokerClient.Server.MessageCallbacks, PokerClient.Protobufs.Objects.ChangeMailReply, PokerClient.Server.MessageContainer,
