unit PokerClient.Forms.PublicClubsList;
...
uses
  PokerClient.Server.Socket, PokerClient.Common.Misc, PokerClient.Protobufs.Enum.ServerCodes, PokerClient.DataModule, PokerClient.Forms.JoinClub, PokerClient.Server.MessageCallbacks, PokerClient.Server.MessageContainer, PokerClient.Common.FormsContainer,
  PokerClient.Protobufs.Objects.ListClubsReply, PokerClient.Protobufs.Objects.Club;
