...
uses
  ...
  Poker.Players.Stats in 'modules\players\Poker.Players.Stats.pas',
  ...
  Poker.Pots.Pot in 'modules\pots\Poker.Pots.Pot.pas',
  Poker.Pots.PotList in 'modules\pots\Poker.Pots.PotList.pas',
