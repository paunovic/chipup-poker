...
HEADERS += ../client/loginwindow.h ../client/table.h ../client/table/tablelayout.h
SOURCES += ../client/loginwindow.cpp ../client/table.cpp ../client/data/playerclubstatus.cpp ../client/table/tablelayout.cpp
