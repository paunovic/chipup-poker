...
void protobuf_AssignDesc_common_2eproto() {
  ...
  static const int RpcMessage_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RpcMessage, methodid_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RpcMessage, datasize_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RpcMessage, token_),
  };
...
void protobuf_AddDesc_common_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\014common.proto\022\005Poker\"E\n\nRpcMessage\022\020\n\010M"
    "ethodId\030\001 \002(\005\022\023\n\010DataSize\030\002 \001(\005:\0010\022\020\n\005To"
    "ken\030\003 \001(\005:\0010", 92);
...
const int RpcMessage::kDataSizeFieldNumber;
const int RpcMessage::kTokenFieldNumber;
#endif  // !_MSC_VER

RpcMessage::RpcMessage()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:Poker.RpcMessage)
}
...
RpcMessage::RpcMessage(const RpcMessage& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:Poker.RpcMessage)
}
...
RpcMessage::~RpcMessage() {
  // @@protoc_insertion_point(destructor:Poker.RpcMessage)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:Poker.RpcMessage)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:Poker.RpcMessage)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Poker.RpcMessage)
  return false;
#undef DO_
}
...
void RpcMessage::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:Poker.RpcMessage)
  // required int32 MethodId = 1;
  if (has_methodid()) {
  ...
  // @@protoc_insertion_point(serialize_end:Poker.RpcMessage)
}

::google::protobuf::uint8* RpcMessage::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Poker.RpcMessage)
  // required int32 MethodId = 1;
  if (has_methodid()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Poker.RpcMessage)
  return target;
}
