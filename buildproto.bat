if exist "C:\dev-cpp\devcpp.exe" (GOTO :setdevcpp) else (if exist "c:\Program Files (x86)\MSBuild\14.0\Bin\MSBuild.exe" (GOTO :setvs) else (GOTO :notfound))
...
:setvs
	...
	set buildcommand="c:\Program Files (x86)\MSBuild\14.0\Bin\MSBuild.exe" "cpp-protobuf-generator-vs\cpp-protobuf-generator.sln"
	goto :build
