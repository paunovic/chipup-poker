...
copy /y "cpp-protobuf-generator\output\PokerClient.Protobufs.Enum.ServerCodes.pas" "client\src\modules\protobuf\objects\PokerClient.Protobufs.Enum.ServerCodes.pas"
